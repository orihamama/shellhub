...
type NamespaceSettingsWithAutoAccept = NamespaceSettings & {
  device_auto_accept?: boolean;
};
...
export default function Settings() {
  ...
  const rawSettings = ns?.settings as NamespaceSettingsWithAutoAccept | undefined;
  const settings = normalizeNamespaceSettings(rawSettings);
  const sessionRecord = settings.session_record;
  const deviceAutoAccept = rawSettings?.device_auto_accept ?? false;
